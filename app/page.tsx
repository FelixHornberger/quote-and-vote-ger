        ...
        <div className="px-5 flex justify-center">
          <div className="task-box mb-3 max-w-prose place-items-center px-5 border border-neutral-900">
              <p className="">
                ...
                Ziel dieser Studie ist es, den Teilnehmern verschiedene Möglichkeiten zu bieten, sich über eine Gruppierung ihrer Wahl zu informieren, und zu analysieren, wie sich dies auf ihre Beschäftigung mit dem Material und den Umfang des erworbenen politischen Wissens auswirkt.
